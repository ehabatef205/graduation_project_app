...
class UpdateProfileAdminCubit extends Cubit<UpdateProfileAdminStates> {
  UpdateProfileAdminCubit() : super(UpdateProfileAdminInitialState());

  static UpdateProfileAdminCubit get(context) => BlocProvider.of(context);
  ...
  void updateProfileAdmin({required BuildContext context}) {
    try {
      isLoading = true;
