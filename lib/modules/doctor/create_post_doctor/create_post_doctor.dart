...
class CreatePostDoctorScreen extends StatelessWidget {
  ...
  const CreatePostDoctorScreen({Key? key, required this.courseId}) : super(key: key);
            ...
            return WillPopScope(
              onWillPop: () async {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ViewPostsCourseDoctorScreen(course_id: courseId)));
                        ...
                        cubit.isLoading
                            ...
                            : Container(
                                ...
                                child: MaterialButton(
                                  onPressed: () {
                                    cubit.addPost(context: context, courseId: courseId);
                                  },
