...
import 'package:graduation_project_app/modules/doctor/view_comments_doctor/cubit/cubit.dart';
...
class ViewCommentsDoctorScreen extends StatelessWidget {
  final Respone list;

  const ViewCommentsDoctorScreen({required this.list, Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>
          ViewCommentsDoctorCubit()..updateRespone(list),
      child: BlocConsumer<ViewCommentsDoctorCubit, ViewCommentsDoctorStates>(
        listener: (context, state) {},
        builder: (context, state) {
          ViewCommentsDoctorCubit cubit = ViewCommentsDoctorCubit.get(context);
          return Scaffold(
            appBar: AppBar(
              title: Text(
                "Comments",
